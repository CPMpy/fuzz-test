...
def write_test_data(lock, output_dir: str, test_results: dict, start_time: float, current_amount_of_tests, current_amount_of_error, solver: str, models: list, permutations: int, skip_global_constraints: bool, rseed: int) -> None:
    """
    ...
    Args:
        ...
        permutations (int): the amount of permutations that we are using for the tests
...
if __name__ == '__main__':
    ...
    # check if all the model dirs exists
    for model in models:
