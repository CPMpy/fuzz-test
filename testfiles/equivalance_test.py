...
def metamorphic_test(solver: str, iters: int, model_file: str, exclude_dict: dict) -> dict:
    """
    A helper function that will execute a single equivalance test
...
def equivalance_tests(test_results: dict, current_amount_of_tests, current_amount_of_error, lock, solver: str, iters: int, folders: list, max_error_treshold: int, rseed: int) -> None:
    """
        A function that will execute multiple equivalance test
